...
<body class="bg-navy-950 font-sans antialiased text-white">
    ...
    // ============================================
    // BADAN JERSEY (Body) - PAKAI SVG PATH
    // ============================================
    const bodyPath = `
        M 150 80
        Q 150 60, 170 60
    ...
    // ============================================
    // HIGHLIGHT (Efek Cahaya di Tengah)
    // ============================================
    const highlightPath = `
        M 220 80
        L 280 80
    ...
    const highlight = new fabric.Path(highlightPath, {
    ...
    const leftSleeve = new fabric.Path(leftSleevePath, {
        fill: sleeveColor,
        selectable: false,
        evented: false,
        stroke: 'rgba(0,0,0,0.1)',
    ...
    const rightSleeve = new fabric.Path(rightSleevePath, {
        fill: sleeveColor,
        selectable: false,
        evented: false,
        stroke: 'rgba(0,0,0,0.1)',
    ...
    // KERAH V-NECK
    // ============================================
    const collarGroup = new fabric.Group([
        // Kerah kiri
        new fabric.Path('M 200 60 L 220 60 L 240 120 L 230 125 Z', {
            fill: '#ffffff',
            stroke: 'rgba(0,0,0,0.1)',
            strokeWidth: 1
        }),
        // Kerah kanan
        new fabric.Path('M 300 60 L 280 60 L 260 120 L 270 125 Z', {
            fill: '#ffffff',
            stroke: 'rgba(0,0,0,0.1)',
            strokeWidth: 1
        }),
        // V-shape tengah
        new fabric.Path('M 230 125 L 250 140 L 270 125 L 260 120 L 250 130 L 240 120 Z', {
            fill: '#ffffff',
            stroke: 'rgba(0,0,0,0.1)',
            strokeWidth: 1
        })
    ...
    if (patternType === 'stripe') {
        for (let i = 180; i < 320; i += 30) {
            const stripe = new fabric.Rect({
                left: i, top: 100, width: 4, height: 500,

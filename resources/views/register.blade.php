...
<body class="font-sans antialiased bg-navy-950 min-h-screen relative">
    ...
    <div class="fixed inset-0 z-0 opacity-20 pointer-events-none"></div>
                ...
                <div class="hidden lg:flex flex-col relative bg-navy-800 overflow-hidden">
                    <div class="absolute inset-0">
                        <img src="{{ asset('images/register-bg.jpg') }}" 
                             onerror="this.src='https://images.unsplash.com/photo-1576633587382-13ddf37b1fc1?q=80&w=1000&auto=format&fit=crop'"

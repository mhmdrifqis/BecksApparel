...
@section('title', 'Tambah User - Becks Apparel')
...
<div class="min-h-screen bg-navy-950 pt-32 pb-16">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-4xl font-black text-white mb-2">Tambah User Baru</h1>
            <p class="text-slate-400">Buat akun user baru dengan role yang ditentukan</p>
        </div>
            ...
            <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <input type="tel" name="nomor_telepon" value="{{ old('nomor_telepon') }}" required maxlength="15"
                ...
                <!-- Password -->
                <div>
                    <label class="block text-sm font-bold text-slate-300 mb-2 uppercase tracking-wide">Password</label>
                    <div class="relative group">
                ...
                <!-- Confirm Password -->
                <div>
                    <label class="block text-sm font-bold text-slate-300 mb-2 uppercase tracking-wide">Konfirmasi Password</label>
                    <div class="relative group">
                        <i data-lucide="lock" class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-lime-400 transition" width="18"></i>
